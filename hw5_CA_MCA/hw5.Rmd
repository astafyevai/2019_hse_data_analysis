...
По данным графика, "черный" характерен разговорной речи, "белый" используется во многих стилях (например, в академическом, разговорном, художественном), в академическом стиле слова для обозначения цвета используются редко, а в художественном для описания цвета используется множество различных прилагательных (например, "розовый", "пурпурный", "голубой", "желтый" и т.д.).
